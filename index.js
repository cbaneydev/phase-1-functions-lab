...
function distanceTraveledInFeet(a, b){
    if(a > b) {
        return (a - b) * 264
    } else {
        return (b - a) * 264
...
distanceTraveledInFeet(62, 60)

function calculateFairPrice(a, b) {
    let distance = distanceTraveledInFeet(a, b)
    if(distance < 400){
        return "It's free."
...
console.log(calculateFairPrice(34, 24))